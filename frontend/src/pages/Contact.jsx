      ...
      <section className="py-20">
        <div className="max-w-[1400px] mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="rounded-xl bg-white border border-gray-100 shadow-sm p-6">
              <div className="flex items-center gap-3"><div className="w-11 h-11 rounded-lg bg-amber-500/10 flex items-center justify-center"><Phone className="w-5 h-5 text-amber-600" /></div><div><p className="font-bold text-[14px] text-mce-navy">Téléphone</p><div className="flex flex-col"><a href="tel:+221338200936" className="text-[12.5px] text-mce-navy/70 hover:text-mce-teal">Sénégal : +221 33 820 09 36</a><a href="tel:+33698681150" className="text-[12.5px] text-mce-navy/70 hover:text-mce-teal">France : +33 6 98 68 11 50 (WhatsApp)</a></div></div></div>
            </div>
            <div className="rounded-xl bg-white border border-gray-100 shadow-sm p-6">
              <div className="flex items-center gap-3"><div className="w-11 h-11 rounded-lg bg-purple-500/10 flex items-center justify-center"><Mail className="w-5 h-5 text-purple-600" /></div><div><p className="font-bold text-[14px] text-mce-navy">Email</p><a href="mailto:mceproagency@gmail.com" className="text-[12.5px] text-mce-navy/70 hover:text-mce-teal">mceproagency@gmail.com</a></div></div>
            </div>
            <div className="rounded-xl bg-white border border-gray-100 shadow-sm p-6">
